...
public class RecetaDAOImpl implements Dao<Receta> {
    ...
    public void guardar(Receta receta) {
        // REQUISITO: Incluimos id_usuario para la relación 1:N
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            // Vinculamos con el ID del usuario autor
            pstmt.setInt(4, receta.getUsuario().getId());
    ...
    public List<Receta> listarTodos() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                // Aquí podrías cargar un usuario básico si fuera necesario
                lista.add(r);
            }
        } catch (SQLException e) {
